            ...
            <div>
              ...
              <input
                ...
                value={config.database_path || ''}
                  className="w-full px-3 py-2 border border-input rounded-md shadow-sm focus:ring-ring focus:border-ring bg-background text-foreground"
                readOnly
              />
            ...
            {validation.tables.length > 0 ? (
              <div className="grid gap-6">
                {validation.tables.map((table) => (
                  <div key={table.name} className="bg-card border border-border rounded-lg p-6 shadow-sm">
